            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <AnimatedSection delay={0.1}>
                <div className="rounded-xl overflow-hidden shadow-2xl">
                  <img src="/images/placeholder-industrial-automation.jpg" alt="A technician assembling a 5G base station unit in a factory" />
                </div>
              </AnimatedSection>
            </div>
          </div>
        ...
        <section id="quality" className="py-20 bg-white">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <AnimatedSection delay={0.1}>
                    <div className="rounded-xl overflow-hidden shadow-2xl">
                        <img src="/images/placeholder-rf-testing-lab.jpg" alt="A piece of networking equipment inside an environmental testing chamber undergoing temperature and humidity stress tests" />
                    </div>
                </AnimatedSection>
                <AnimatedSection>
