        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-illuminious-navy/70 mb-4">
              By accessing or using the Illuminious LLC ("Company," "we," "our," or "us") website
            ...
            <p className="text-illuminious-navy/70 mb-4">
              ...
              is the property of Illuminious LLC and is protected by intellectual property laws.
            ...
            <p className="text-illuminious-navy/70 mb-4">
              To the maximum extent permitted by law, Illuminious LLC shall not be liable for any
            ...
            <p className="text-illuminious-navy/70 mb-4">
              You agree to indemnify and hold harmless Illuminious LLC, its officers, directors,
            ...
            <p className="text-illuminious-navy/70 mb-4">
              ...
              laws of the State of Wyoming, United States, without regard to its conflict of law
              provisions. Any disputes shall be resolved in the courts of Sheridan County, Wyoming.
            </p>
