    ...
    <>
      ...
      <section className="relative pt-48 pb-32 bg-illuminious-navy text-white overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/images/DEPLOYED_backup-smt-placement-wearable-pcb-11.jpg"
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <AnimatedSection delay={0.1}>
                <div className="rounded-xl overflow-hidden shadow-2xl">
                  <img src="/images/DEPLOYED_placeholder-smt-assembly-line.jpg" alt="High-speed pick-and-place machine in action" />
                </div>
              </AnimatedSection>
            </div>
          </div>
        ...
        <section id="quality" className="py-20 bg-illuminious-light/30">
          <div className="container grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              <div className="rounded-xl overflow-hidden shadow-2xl">
                <img src="/images/DEPLOYED_smtassembly-img-2.jpg" alt="Technician operating a 3D AOI machine" />
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.1}>
