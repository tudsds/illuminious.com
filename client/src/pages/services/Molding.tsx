            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <AnimatedSection delay={0.1}>
                <div className="rounded-xl overflow-hidden shadow-2xl">
                  <img src="/images/placeholder-injection-molding-factory-line.jpg" alt="A robotic arm removing a freshly molded plastic part from an injection molding machine" />
                </div>
              </AnimatedSection>
            </div>
          </div>
        ...
        <section id="why-us" className="py-20 bg-gray-50">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <AnimatedSection>
                <div className="rounded-xl overflow-hidden shadow-2xl">
                  <img src="/images/placeholder-technician-inspecting-mold.jpg" alt="An engineer inspecting a large, complex injection mold" />
                </div>
              </AnimatedSection>
              <AnimatedSection delay={0.1}>
